...
const (
	OrdersService_Get_FullMethodName = "/order.ser.OrdersService/Get"
)
...
//
// 定义Orders服务
// => 相当于 go 中的 type OrdersService interface{}
type OrdersServiceClient interface {
	// => 相当于go中 接口的结构体内
	Get(ctx context.Context, in *Orders, opts ...grpc.CallOption) (*Orders, error)
}
...
func (c *ordersServiceClient) Get(ctx context.Context, in *Orders, opts ...grpc.CallOption) (*Orders, error) {
...
type OrdersServiceServer interface {
	// => 相当于go中 接口的结构体内
	Get(context.Context, *Orders) (*Orders, error)
...
func (UnimplementedOrdersServiceServer) Get(context.Context, *Orders) (*Orders, error) {
...
func _OrdersService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).Get(ctx, req.(*Orders))
	}
...
var OrdersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "order.ser.OrdersService",
